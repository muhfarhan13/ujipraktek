...
<head>
    ...
    <meta rt" content="width=device-width, initial-scale=1.0">
                    ...
                    <form action="updatedata.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <?php
                                $id = $_GET['id'];
                                $ambildata = mysqli_query($connect, "SELECT * FROM produk WHERE id_produk = '$id'");
                                if ($narikdata = mysqli_fetch_array($ambildata)) {
                                ?>
                                    <div class="input-group">
                                        <input type="hidden" class="form-control mb-2" name="id" value="<?php echo $narikdata['id_produk']; ?>">
                                    </div>
                                    <div class="input-group">
                                        <input type="text" class="form-control mb-2" name="nama" value="<?php echo $narikdata['nama_produk']; ?>">
                                    </div>
                                    <div class="input-group">
                                        <input type="text" class="form-control mb-2" name="gambar" value="<?php echo $narikdata['gambar_produk']; ?>">
                                    </div>
                                    <div class="input-group">
                                        <input type="text" class="form-control mb-2" name="deskripsi" value="<?php echo $narikdata['deskripsi']; ?>">
                                    </div>
                            </div>
